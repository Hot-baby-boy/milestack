        ...
        <div className="flex h-full flex-col overflow-hidden">
          ...
          <div className="flex h-[60px] flex-shrink-0 items-center gap-3 border-b border-slate-100 bg-white pl-4 pr-4 lg:h-[72px] lg:pl-6 lg:pr-20">
            ...
            <Link href={`/dashboard/${project.id}`}
              className="flex-shrink-0 rounded-full border border-slate-200 px-3 py-1.5 text-[12px] font-medium text-slate-500 hover:border-slate-300 hover:text-slate-700 transition"
            >
              Open workspace →
            </Link>
          </div>
